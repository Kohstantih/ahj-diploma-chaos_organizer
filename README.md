...
иныормацию сторонних сервисов по запросу. Приложение синхронизировано, если оно открыто на нескольких устройствах, то контент обновляется синхронно на всех. Информация хранится в виде сообщений, сначала подгружаются последние 10 сообщений, при прокрутке вверх подгружаются следующие 10 и т. д.
...
__Список команд:__
- **_погода_** (прогноз погоды на текущий момент)
